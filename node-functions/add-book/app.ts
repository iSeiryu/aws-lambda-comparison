...
export const lambdaHandler = async (event: APIGatewayProxyEvent): Promise<APIGatewayProxyResult> => {
    logStart()
    var body = JSON.parse(event.body) as Book // this isn't the best way to do it, we'd need to implement a validator, which isn't difficult.
    console.log(body)
    body.title += "Modified"
    ...
    body.published = publishedDate.toDateString()
